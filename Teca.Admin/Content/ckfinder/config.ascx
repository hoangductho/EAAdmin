...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //BaseDir = FX.Core.FXContext.Current.PhysicalSiteDataDirectory + "UserFiles";
        BaseDir = FX.Context.FXContext.Current.PhysicalSiteDataDirectory;        
        ...
        type = ResourceType.Add(HttpContext.Current.User.Identity.Name);
        type.Url = BaseUrl + "/" + HttpContext.Current.User.Identity.Name + "/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "/" + HttpContext.Current.User.Identity.Name + "/";
		type.MaxSize = 0;
		...
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "swf", "flv","mkv", "avi","mp4" };
		type.DeniedExtensions = new string[] { };        

        type = ResourceType.Add("Banners");
        type.Url = BaseUrl + "/banners/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "/banners/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "swf", "flv" };
        type.DeniedExtensions = new string[] { };
